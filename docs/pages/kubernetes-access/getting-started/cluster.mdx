...
While completing this guide, you will deploy a single Teleport container running the Auth Service and Proxy Service on your Kubernetes cluster, including a `LoadBalancer` that exposes these services to traffic outside the cluster.
