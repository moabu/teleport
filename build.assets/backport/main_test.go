...
func TestParseCommit(t *testing.T) {
	tests := []struct {
		...
		{
			input:    "22ac10ffc48a80bb4d76f",
			expected: "",
			desc:     "input-does-not-match",
		},
		{
			input:    "22ac10ffc48a80bb4d76fcdd64e1680735996aaa\n\n\n",
			expected: "22ac10ffc48a80bb4d76fcdd64e1680735996aaa",
			desc:     "input-has-new-lines-with-match",
		},
		{
			input:    "\"22ac10ffc48a80bb4d76fcdd64e1680735996aaa\n",
			expected: "22ac10ffc48a80bb4d76fcdd64e1680735996aaa",
			desc:     "input-has-quotes-with-match",
		},
	}
	for _, test := range tests {
		t.Run(test.desc, func(t *testing.T) {
			expect := parseCommit(test.input)
			require.Equal(t, expect, test.expected)
		})
	}
}
